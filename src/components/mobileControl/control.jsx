    ...
    return (
        <>
            <div
                className={
                    isClose
                        ? 'mobile-control slide-out'
                        : 'mobile-control slide-in'
                }
            >
                <div className="wrapper-content">
                    {isShowBtn ? (
                        <div style={{ display: 'flex', height: 40 }}>
                            <div className="button-icon" onClick={onDefault}>
                                Default
                            </div>
                            <div className="button-icon" onClick={onOkey}>
                                Ok
                            </div>
                        </div>
                    ) : (

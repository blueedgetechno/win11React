...
export const fetchStore = async () => {
  ...
  const resp = await fetch(`https://dgckwjucklewsucocfgw.supabase.co/rest/v1/stores?select=id,name,icon,type,created_at,metadata->description,metadata->screenshoots,metadata->feature`, {
    method: "GET",
    headers: {

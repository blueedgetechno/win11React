...
export const home = (props) => {
  return (
    <svg viewBox="0 0 512 512" width={24} height={24} {...props}>
      <path d="M448 463.746H298.667V314.413h-85.334v149.333H64V148.318L256 36.572l192 110.984v316.19z" fill="currentColor" />
    </svg>
  );
};
...
export const search = (props) => {
  return (
    <svg height={24} width={24} viewBox="0 0 512 512" aria-hidden="true" {...props}>
      <path d="M349.714 347.937l93.714 109.969-16.254 13.969-93.969-109.969q-48.508 36.825-109.207 36.825-36.826 0-70.476-14.349t-57.905-38.603-38.603-57.905-14.349-70.476 14.349-70.476 38.603-57.905 57.905-38.603 70.476-14.349 70.476 14.349 57.905 38.603 38.603 57.905 14.349 70.476q0 37.841-14.73 71.619t-40.889 58.921zM224 377.397q43.428 0 80.254-21.461t58.286-58.286 21.461-80.254-21.461-80.254-58.286-58.285T224 57.397t-80.254 21.46-58.285 58.285-21.46 80.254 21.46 80.254 58.285 58.286T224 377.397z" fill="currentColor" />
    </svg>
  );
};
...
export const sort = (props) => {
  return (
    <svg viewBox="0 0 416 330" {...props}>
      <path stroke="currentColor" fill="currentColor" d="M124 1h8l6 2 4 3 106 107 4 8v9l-2 5-5 6-8 4h-9l-8-4-71-71-1 144-1 1v81q-2 8-8 12l-6 3h-11q-8-3-12-8l-2-3-1-3v-5l-1-1V133l1-1V70l-69 69-3 4-8 4H17l-10-5v-1l-5-7-1-8q2-1 1-5l3-5L116 5l8-4z" />
      <path fill="var(--clrPrm)" stroke="var(--clrPrm)" d="M284 17h12q7 3 11 9l3 6 1 226 70-71 9-5h12l5 2 7 8 2 4v14l-3 6-110 110-5 3q-4-1-4 1h-9l-7-3-4-3-108-107-4-8v-11l3-7 6-6 6-3h13l6 3 72 72V33l2-5 6-7 8-4z" />
    </svg>
  );
};
...
export const New = (props) => {
  return (
    <svg viewBox="0 0 500 500" {...props}>
      <path fill="var(--clrPrm)" stroke="var(--clrPrm)" d="M245 151h11q4 2 7 6l3 6v71h72q6 2 9 7l2 4v11l-5 7-6 3h-72v72q-2 6-6 9l-4 2h-11l-8-5-3-6v-72h-71q-7-2-10-6l-2-4v-11q2-5 6-8l6-3h71v-71q2-7 7-10l4-2z" />
...
export const info = (props) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" {...props}>
      <path fill="#0078d7" d="M27.34 3.45c7.1-1.02 14.61.32 20.59 4.4 8.03 5.14 13.14 14.6 12.91 24.15.27 10.76-6.27 21.26-15.95 25.91-9.25 4.63-21.06 3.84-29.49-2.22-8.32-5.6-13.09-15.91-12.18-25.88C3.8 16.8 14.5 5.29 27.34 3.45M30 14v4h4v-4h-4m0 8v28h4V22h-4z" />
...
export const taskSearch = (props) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="-2 -1 26 26" height="28" width="28" class="svelte-c9w43z">

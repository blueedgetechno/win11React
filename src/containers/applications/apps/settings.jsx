...
export const Settings = () => {
    const wnapp = useAppSelector((state) =>
        state.apps.apps.find((x) => x.id == 'settings')
    );
                                            ...
                                            switch (e.type) {
                                                ...
                                                case 'langSwitcher':
                                                    return (
                                                        <div
                                                            key={i}
                                                            className="tile langSwitcherTile"
                                                        >
                                                            <span className="settingsIcon">
                                                                
                                                            </span>
                    ...
                    {upmodalOpen && (
                        <>
                            ...
                            >
                                ...
                                <p>
                                    Some changes will not take effect until you
                                    restart your device.
                                </p>

        ...
        return (
          ...
          >
            <Image
              ...
              ext
            />
            <div className="capitalize text-xs text-center font-semibold" style={{ color: app.steam_off ? '#313131' : '' }}>
              {app.name}
            </div>
            <div className="text-[11px] text-center font-regular" style={{color:'#313131'}}>
              {app.steam_off ? `(${t("info.withoutAcc")})` : ""}
            </div>
            <div className="text-[11px] text-center font-regular" style={{ color: app.steam_off ? '#313131' : '' }}>
              {CheckAppPriority(app.volume_class)}
            </div>
          </div>
        );

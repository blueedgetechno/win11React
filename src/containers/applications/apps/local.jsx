...
export function Local() {
    ...
    const handleConfigure = async () => {
        setComputer(await ConfigureDaemon(address));
        try {
            setInfo(await GetInfo(await ConfigureDaemon(address)));
        } catch (e) {
            setInfo(null)
        }
    };
    ...
    const connect = async (e) => {
        e.preventDefault();
        if (mode == 'thinkmay') await handleThinkmay(e);
        else if (mode == 'moonlight') await handleMoonlight(e);
        else if (mode == 'virtdaemon' && target == null) await handleVirtdaemon(e);
        else if (mode == 'virtdaemon' && target != null) await connectVirtdaemon(e);
    };
    ...
    const handleThinkmay = async (e) => {
        e.preventDefault();
        appDispatch(local_access(await StartThinkmay(computer)));

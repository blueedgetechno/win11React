...
import { FetchApplicationTemplates } from '../../../backend/reducers/fetch';
    ...
    return (
        <div className="h-full relative p-[16px]">
            ...
            {vendors.length >= 1 ? (
                    ...
                    <div className="grid grid-cols-3 gap-[16px] ">
                        {vendors.map((item) => (
                            <VendorInfo
                                ...
                                isChoosen={
                                    item.app_template_id ==
                                    vendorChoosen.app_template_id
                                }
                            />
                        ))}
                    </div>
                ...
                <h3>
                    Sorry:(( We're run out of VM, please give us a contact if
                    you need ^^
                </h3>
            )}
        </div>

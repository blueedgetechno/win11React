...
import { GetUserIdByEmail, GetUserSetting, UpdateUserSetting } from "../../../backend/reducers/fetch";
...
export function user_config() {
	...
	return (
		<div
			className="userConfig w-[320px] bg-slate-500"
		>

			<div className="flex gap-4">
				<input type="text" placeholder="Email" onChange={(e) => { setEmail(e.target.value) }} />
				<button className="instbtn" onClick={() => { findUser() }}>Find</button>
			</div>
			...
			<form className="flex flex-col gap-4" onSubmit={handleSubmit}>
				...
				<div className="flex gap-4">
					<button className="instbtn w-2/3" type="submit">Save</button>
					<button className="w-1/3" type="button" onClick={() => {
